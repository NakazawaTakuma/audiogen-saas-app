...
INSTALLED_APPS = [
    ...
    'mainapp',     # 作成したアプリケーション

    'mainapp.users.apps.UsersConfig',

    'django_crontab',

     'mainapp.audio.apps.AudioConfig',
     'mainapp.billing',  # プラン管理アプリ
]
...
AUTHENTICATION_BACKENDS = [
    # まずカスタムバックエンドを先頭に
    'mainapp.users.backends.EmailOrUsernameModelBackend',
